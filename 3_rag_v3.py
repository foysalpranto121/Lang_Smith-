...
@traceable(name="load_pdf",tags=["setup"], metadata={"description": "Load PDF into LangChain Document objects"})
...
@traceable(name="build_vectorstore",tags=["embedding", "vectorstore"], metadata={"embedding_model": "text-embedding-3-small", "vectorstore_type": "FAISS"})
